...
public class StateRegistro extends InternalState{
	...
	private JLabel 	lblEspecialdiade = new JLabel("Especialidade:"),
					...
					lblExames = new JLabel("Pedidos\n de exames:"),
					lblPrescricoes= new JLabel("Prescricoes:"),
					lblRecomendacoes = new JLabel("Recomendacoes:");
	...
	private JScrollPane scrObservacoes = new JScrollPane(),
						scrExames = new JScrollPane(),
						scrPrescricoes = new JScrollPane(),
						scrRecomendacoes = new JScrollPane();	
	
	private JTextPane 	txpObservacoes = new JTextPane(),
						txpExames = new JTextPane(),
						txpPrescricoes = new JTextPane(),
	...
	private static SimpleDateFormat nf = new SimpleDateFormat("dd/MM/yyyy as HH:mm:ss");
