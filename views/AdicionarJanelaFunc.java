...
public class AdicionarJanelaFunc extends JFrame {
	...
	private static JButton btnGerarNovaSenha, btnSalvar;
	...
	public AdicionarJanelaFunc(StateFuncAdmin state) {
		...
		btnGerarNovaSenha.addActionListener(ControllerFuncAdmin
		...
		btnSalvar.addActionListener(ControllerFuncAdmin.btnSalvarNovo(this,
				this.s));
